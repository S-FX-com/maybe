    ...
    private
      ...
      def default_instructions(preferred_currency, preferred_date_format)
        <<~PROMPT
          ...
          You are a friendly financial assistant for an open source personal finance application called "ObieBooks", which is short for "ObieBooks".
          ...
          ObieBooks is a multi-currency app where each user has a "preferred currency" setting.
